...
try:
    ...
    for item in comment_request.json():
        ...
        users_list_name.append(item['author']['name'])
    ...
    for item in user_num:
        ...
        item_discussion_share = str(round(float(item[1])/len(users_list)*100, 2))
    ...
    print("")
    print(users_list_len + " participants commented until " + execution_date)
